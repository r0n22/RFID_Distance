...
namespace _2DDistancing.Code
{
    ...
    partial void InsertTagAssocation(TagAssocation instance);
    partial void UpdateTagAssocation(TagAssocation instance);
    partial void DeleteTagAssocation(TagAssocation instance);
    #endregion
		...
		public System.Data.Linq.Table<TagAssocation> TagAssocation
		{
			get
			{
				return this.GetTable<TagAssocation>();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.TableAttribute()]
	public partial class TagAssocation : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnTag_valueChanging(string value);
    partial void OnTag_valueChanged();
    #endregion
		
		public TagAssocation()
		{
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Tag_value", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		public string Tag_value
		{
			...
			set
			{
				if ((this._Tag_value != value))
				{
					this.OnTag_valueChanging(value);
					this.SendPropertyChanging();
					this._Tag_value = value;
					this.SendPropertyChanged("Tag_value");
					this.OnTag_valueChanged();
				}
			}
		}
